<template>
  <div>
    <div class="text-3xl w-full font-bold mt-2">
      <div class="w-fit m-auto">{{ useMonthlyStore().getName }}</div>
    </div>
    <div :class="['gap-6 my-6 mx-auto grid ' + (windowWidth > 768 ? 'grid-cols-2 w-[60%]' : 'w-[80%]')]">
      <div v-for="i in useMonthlyStore().getList">
...
<script setup>
import { useMonthlyStore } from '../../../store/store';
